# Conventions — Dijital Mentor

How code is written and changes are verified here. Complements `CONSTITUTION.md` (the *why*) with the
*how*.
...
src/lib/ai/                   # Claude tool-use generation + repair
