...
export const de = {
	...
	editor: {
		shell: {
			...
			republish: 'Live-Website aktualisieren',
			resolvePublish: 'Veröffentlichungshindernis lösen',
			saveNow: 'Jetzt speichern',
			savedPreview: 'Gespeicherte Vorschau öffnen',
			publishedVersion: 'Live v{version}',
			notPublished: 'Noch nicht live',
			savedDraft: 'Entwurf gespeichert',
			savingDraft: 'Entwurf wird gespeichert',
			unsavedDraft: 'Ungespeicherte Änderungen',
			...
			blockerCount: '{count} Hindernis(se)',
			warningCount: '{count} Warnung(en)',
			noBlockers: 'Keine kritischen Veröffentlichungshindernisse',
			qualityHelp: 'Für Details öffnen. Nur kritische Hindernisse stoppen die Veröffentlichung.',
			mobile: 'Mobil · 375 px',
			tablet: 'Tablet · 768 px',
			desktop: 'Desktop · flexibel',
			previewTitle: 'Live-Vorschau der Website'
		},
		blocks: {
			hero: 'Hero',
			about: 'Über uns',
		...
		chat: {
			...
			contextLabel: 'Du arbeitest an {page}',
			greeting:
				'Hallo! Lass uns über deine Website sprechen — was möchtest du ändern? Farbe, Text, Abschnitte, Seiten … erzähl es mir einfach.',
			promptNotes: 'Gespeicherte Anweisungen',
			promptNotesHelp: 'Wiederverwendbare Ideen für deine Website',
			promptNotesOpen: 'Öffnen',
			promptNotesHide: 'Ausblenden',
			promptSavePlaceholder: 'Eigene Anweisung speichern…',
			promptSave: 'Speichern',
			promptCustomTitle: 'Meine Anweisung',
			promptClarityTitle: 'Klarere Texte',
			promptClarityText: 'Formuliere die Seitentexte klarer, wärmer und leichter erfassbar.',
			promptSpacingTitle: 'Mehr Freiraum',
			promptSpacingText:
				'Gib den Hauptabschnitten mehr Freiraum und lass die Seite ruhiger wirken.',
			promptTrustTitle: 'Vertrauen aufbauen',
			promptTrustText:
				'Lass die Seite für neue Besucher vertrauenswürdiger wirken, ohne Behauptungen zu erfinden.',
			promptMobileTitle: 'Mobile Optimierung',
			promptMobileText:
				'Verbessere den mobilen Lesefluss und mache wichtige Aktionen leicht auffindbar.',
	...
	legal: {
		aiDisclaimer: {
			title: 'KI-übersetzter Entwurf',
			body: 'Diese Seite wurde von einer KI aus dem türkischen Original übersetzt und nicht von einem Anwalt geprüft. Die türkische Fassung ist der maßgebliche Text.'
		}
	},
	admin: {
		nav: {
			...
			share: 'Teilen',
			support: 'Support',
			invites: 'Beta-Einladungen',
			settings: 'Einstellungen',
			backToApp: 'Zur App'
		},
		chrome: { console: 'Admin-Konsole', ariaLabel: 'Administration', eyebrow: 'Administration' },
		list: {
			customersTitle: 'Kunden',
			customersDescription: 'Alle Konten, ihre Tarife und die KI-Nutzung dieses Monats.',
			customerCount: '{count} Kunde(n)',
			noCustomers: 'Noch keine Kunden.',
			proSites: '{count} Pro-Website(s)',
			view: 'Ansehen',
			inboxTitle: 'Posteingang',
			inboxDescription:
				'Öffentliche Kontaktformular- und Nachrichtenanfragen, zuletzt aktive zuerst.',
			inquiryCount: '{count} Anfrage(n)',
			noInquiries: 'Keine öffentlichen Anfragen.',
			supportTitle: 'Support',
			supportDescription: 'Alle Kundenanfragen, zuletzt aktive zuerst.',
		...
		invites: {
			title: 'Beta-Einladungen',
			description: 'Lade Kunden per E-Mail ein und verwalte den Zugang zur geschlossenen Beta.',
			access: 'Zugang zur geschlossenen Beta',
			enabled: 'Nur aktive Eingeladene können sich anmelden.',
			disabled: 'Die Anmeldung ist derzeit für alle geöffnet.',
			enable: 'Geschlossene Beta aktivieren',
			disable: 'Geschlossene Beta deaktivieren',
			email: 'E-Mail',
			profession: 'Beruf',
			language: 'Sprache',
			...
			deliveryFailed: 'Einladung gespeichert, aber E-Mail-Zustellung fehlgeschlagen: {error}'
		},
		blog: {
			title: 'Blog',
			description:
				'Verwalte mehrsprachige Plattformartikel, SEO-Zusammenfassungen, Titelbilder und Veröffentlichungsstatus.',
			newPost: 'Neuer Beitrag',
			importJson: 'JSON importieren',
			importTitle: 'Mehrsprachiges JSON importieren',
			importHelp:
				'Lade eine strukturierte JSON-Datei mit vollständigen EN/TR/DE-Übersetzungen hoch. Veröffentlichte Importe werden bei unvollständiger Sprache blockiert.',
			jsonFile: 'JSON-Datei',
			updateExisting: 'Vorhandenen Beitrag bei übereinstimmendem Slug aktualisieren',
			posts: '{count} Beitrag/Beiträge',
			publicBlog: 'Öffentlichen Blog ansehen',
			empty: 'Noch keine Beiträge.',
			edit: 'Bearbeiten',
			open: 'Öffnen',
			back: 'Zurück zum Blog',
			openPublic: 'Öffentlich öffnen',
			saved: 'Blogbeitrag gespeichert.',
			editDescription: 'Bearbeite den öffentlichen Blogartikel auf Türkisch, Englisch und Deutsch.',
			slug: 'Slug',
			status: 'Status',
			publishDate: 'Veröffentlichungsdatum',
			coverUrl: 'Titelbild-/SEO-Bild-URL',
			...
			body: 'Inhalt',
			writeArticle: '{locale}-Artikel schreiben...',
			save: 'Blogbeitrag speichern',
			chooseFile: 'Wähle eine JSON-Datei zum Importieren.',
			fileTooLarge: 'Die JSON-Importdatei muss kleiner als 512 KB sein.',
			notFound: 'Blogbeitrag nicht gefunden.'
		},
		share: {
			title: 'Story-Share-Assets',
			description:
				'Verwalte die 1080x1920 Bilder und MP4-Videos auf der öffentlichen /share-Seite.',
			page: 'Öffentliche Share-Seite',
			live: '/share ist live — Besucher können die folgenden Assets in ihrer Story teilen.',
			disabled:
				'/share liefert derzeit 404. Aktiviere die Seite, sobald mindestens ein Asset aktiv ist.',
			enable: '/share aktivieren',
			disable: '/share deaktivieren',
			uploadTitle: 'Neues Asset hochladen',
			upload: 'Hochladen',
			uploading: 'Wird hochgeladen…',
			empty: 'Noch keine Share-Assets.',
			active: 'Aktiv',
			hidden: 'Ausgeblendet',
			activate: 'Aktivieren',
			hide: 'Ausblenden',
			saveCaptions: 'Beschriftungen speichern',
			delete: 'Löschen',
			moveUp: 'Nach oben',
			moveDown: 'Nach unten',
			confirmDelete: 'Dieses Asset löschen? Die Datei wird auch aus dem Speicher entfernt.',
			uploaded: '{name} hochgeladen.',
			assetDeleted: 'Asset gelöscht.',
			captionSaved: 'Beschriftung gespeichert.',
			pageEnabled: '/share aktiviert.',
			pageDisabled: '/share deaktiviert.',
			chooseFile: 'Wähle ein Bild oder MP4-Video zum Hochladen.',
			fileTooLarge: 'Die Datei darf maximal 60 MB groß sein.',
			missingAsset: 'Asset-ID fehlt.',
			uploadFailed: 'Upload fehlgeschlagen.',
			storageError: 'Speicherfehler: {error}'
		},
		settings: {
			title: 'Einstellungen',
			description:
				'Zugangsdaten, Laufzeiteinstellungen und Diagnose. Gespeicherte Werte überschreiben .env.',
			valueRequired: 'Ein Wert ist erforderlich.',
			unknownSetting: 'Unbekannte Einstellung.',
			errorNotFound: 'Fehlerdatensatz nicht gefunden.',
			reservationNotFound: 'Reservierung nicht gefunden.'
		},
		copyPanel: {
			title: 'Öffentliche Texte',
			description:
				'Bearbeite Marketingseitentexte ohne Codeänderung. Leere Felder verwenden die integrierten Standardwerte.',
			saved: '{value} gespeichert.',
			reset: '{value} auf die Codestandardwerte zurückgesetzt.',
			open: 'Öffnen',
			editableFields: '{count} bearbeitbare Felder',
			overrideHelp: 'Nur ausgefüllte Felder überschreiben den Standardtext.',
			custom: 'benutzerdefiniert',
			default: 'Standard',
			save: 'Text speichern',
			resetLanguage: 'Diese Sprache zurücksetzen'
		},
		messagePanel: {
			title: 'Nachrichten',
			description:
				'Bearbeite jeden Produkttext ohne Codeänderung. Leere Felder verwenden integrierte Standardwerte.',
			search: 'Suchen',
			searchPlaceholder: 'Nach Schlüssel, Label oder Text suchen…',
			open: 'Öffnen',
			saved: '{value} gespeichert.',
			reset: '{value} auf den Codestandard zurückgesetzt.'
		},
		gtm: {
			description: 'Kampagnenlinks, Onboarding-Funnel und Lead-Triage-Ansicht.',
			starts: 'Q&A gestartet',
			completed: 'Q&A abgeschlossen',
			preview: 'Vorschau erstellt',
			editor: 'Editor geöffnet',
			last7Days: 'letzte 7 Tage',
			sources: 'Kampagnenquellen',
			sourceCount: '{count} Quellen',
			noSources: 'Noch keine kampagnenbezogenen Ereignisse.',
			source: 'Quelle',
			start: 'Start',
			complete: 'Abschluss',
			leadTriage: 'Lead-Triage',
			triageHelp: 'Heiße Leads, Beta-Kandidaten und Compliance-Nachrichten.',
			hot: 'Heiß',
			beta: 'Beta',
			review: 'Prüfung',
			noLeads: 'Noch keine Leads zur Triage.'
		},
		customer: {
			unknown: 'Unbekannter Kunde.',
			invalidPlan: 'Ungültiger Zieltarif.',
			reasonRequired: 'Eine Begründung ist erforderlich.',
			positiveAmount: 'Gib mindestens einen positiven Betrag zur Gutschrift ein.',
			noDomain: 'Für diese Website gibt es keine zu trennende Domain.',
			missingSite: 'siteId fehlt.',
			siteNotFound: 'Website nicht gefunden.',
			publishBlocked: 'Veröffentlichung durch Qualitätsprüfungen blockiert: {reason}',
			reservationInProgress:
				'Für diese Website läuft eine Domainreservierung oder -registrierung; löse sie zuerst.'
		},
		detail: {
			backInbox: 'Zurück zum Posteingang',
			backSupport: 'Zurück zum Support',
			setStatus: 'Status festlegen:',
			youAdmin: 'Du (Admin)',
			youSupport: 'Du (Support)',
			replyEmail: 'Per E-Mail antworten…',
			replyCustomer: 'Dem Kunden antworten…',
			reply: 'Antworten',
			inquiryClosed: 'Diese Anfrage ist geschlossen.',
			ticketClosed: 'Dieses Ticket ist geschlossen.',
			replyStored: 'Antwort gespeichert, E-Mail-Versand versucht.'
		}
	},
	auth: {
