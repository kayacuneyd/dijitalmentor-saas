...
export const en = {
	...
	editor: {
		shell: {
			...
			republish: 'Update live site',
			resolvePublish: 'Resolve publish issue',
			saveNow: 'Save now',
			savedPreview: 'Open saved preview',
			publishedVersion: 'Live v{version}',
			notPublished: 'Not live yet',
			...
			noBlockers: 'No critical publish blockers',
			qualityHelp: 'Open for details. Only critical blockers stop publishing.',
		...
		chat: {
			...
			promptNotesHelp: 'Reusable ideas for your site',
			promptNotesOpen: 'Open',
			promptNotesHide: 'Hide',
			promptSavePlaceholder: 'Save your own instruction…',
			promptSave: 'Save',
			promptCustomTitle: 'My instruction',
			promptClarityTitle: 'Clearer copy',
			promptClarityText: 'Rewrite the page copy to be clearer, warmer, and easier to scan.',
			promptSpacingTitle: 'More breathing room',
			promptSpacingText:
				'Give the main sections more breathing room and make the page feel calmer.',
			promptTrustTitle: 'Build trust',
			promptTrustText:
				'Make the page feel more trustworthy for a first-time visitor without inventing claims.',
			promptMobileTitle: 'Mobile polish',
			promptMobileText:
				'Improve the mobile reading flow and make every important action easy to find.',
