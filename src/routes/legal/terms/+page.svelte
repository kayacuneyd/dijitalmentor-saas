...
<LegalShell title={titles[locale]}>
	...
	{:else if locale === 'de'}
		...
		<p>
			...
			Erscheint Creem beim kostenpflichtigen Checkout als Merchant of Record, können während dieses
			Checkouts zusätzlich Creems eigene Bedingungen zu Zahlung, Rückbuchungen,
	...
	{:else}
		...
		<p>
			Operatör, dolaylı, arızi, sonuçsal veya cezai zararlardan sorumlu değildir. Toplam sorumluluk,
			son 12 ayda kullanıcıdan alınan tutarı aşamaz.
		</p>
